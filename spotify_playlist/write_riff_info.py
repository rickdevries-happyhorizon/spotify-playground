...
def _build_list_info_chunk(title: str, artist: str, genre: str | None = None) -> bytes:
    list_data = b'INFO'
...
def apply_riff_info(path: str, title: str, artist: str, genre: str | None = None) -> None:
    ...
    info_chunk = _build_list_info_chunk(title, artist, genre)
    info_inserted = False
