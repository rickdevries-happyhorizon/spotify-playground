...
NL: dict[str, str] = {
    ...
    "Colorful": "Kleurrijk",
    "Gradients, glow, motion": "Verlopen, gloed, beweging",
    "Language": "Taal",
    ...
    "Scan followed artists and tracking playlists, then import new tracks into the to-do list.": "Scan gevolgde artiesten en tracking-afspeellijsten, en importeer nieuwe tracks naar de to-do lijst.",
    "Scanning followed artists and tracking playlists for new tracks.": "Gevolgde artiesten en tracking-afspeellijsten scannen op nieuwe tracks.",
...
BRAB: dict[str, str] = {
    **NL,
    ...
    "Scan followed artists and tracking playlists, then import new tracks into the to-do list.": "Scan gevolgde artiesten en tracking-playlists, en importeer nieuwe tracks naor de to-do lijst.",
    "Scanning followed artists and tracking playlists for new tracks.": "Gevolgde artiesten en tracking-playlists scannen op nieuwe tracks.",
