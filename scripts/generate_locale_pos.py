...
NL: dict[str, str] = {
    ...
    "Pull new tracks from followed artists, discovered artists, and source playlists into your destination playlist.": "Haal nieuwe tracks uit gevolgde artiesten, ontdekte artiesten en bron-afspeellijsten en zet ze in je doel-afspeellijst.",
    ...
    "Scanning followed artists, discovered artists, and source playlists since your sync start date.": "Gevolgde artiesten, ontdekte artiesten en bron-afspeellijsten scannen sinds je sync-startdatum.",
    "Scan artists": "Artiesten scannen",
    "Current artist": "Huidige artiest",
    "From artists": "Van artiesten",
    "From discovery": "Van discovery",
    "Artist discovery": "Artiestenontdekking",
    "Find new artists from your tracking playlists and add recent releases to the destination playlist.": "Ontdek nieuwe artiesten via je tracking-afspeellijsten en zet recente releases in je doel-afspeellijst.",
    "Enable artist discovery during sync": "Artiestenontdekking inschakelen tijdens sync",
...
BRAB: dict[str, str] = {
    **NL,
    ...
    "Pull new tracks from followed artists, discovered artists, and source playlists into your destination playlist.": "Haol nieuwe tracks uut gevolgde artiesten, ontdekte artiesten en bron-playlists en zet ze in je doel-playlist.",
    ...
    "Scanning followed artists, discovered artists, and source playlists since your sync start date.": "Gevolgde artiesten, ontdekte artiesten en bron-playlists scannen sinds je sync-startdatum.",
    "Scan artists": "Artiesten scannen",
    "Current artist": "Huidige artiest",
    "From artists": "Van artiesten",
    "From discovery": "Van discovery",
    "Artist discovery": "Artiestenontdekking",
    "Find new artists from your tracking playlists and add recent releases to the destination playlist.": "Ontdek nieuwe artiesten via je tracking-playlists en zet recente releases in je doel-playlist.",
    "Enable artist discovery during sync": "Artiestenontdekking aanzetten tijdens sync",
